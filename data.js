...
data = {
	Lektion1: {
		...
		grayBackground: {a: "bg(0.5)",b: "# LOC:1 bg\n"},
		redBackground: {a: "bg(1,0,0)",b: "# LOC:1 bg\n"},
		greenBackground: {a: "bg(0,1,0)",b: "# LOC:1 bg\n"},
		yellowBackground: {a: "bg(1,1,0)",b: "# LOC:1 bg\n"},
	...
	Lektion4: {
		...
		for04: {a:"for (i of range(10)) {for (j of range(10)) {x = 5+20*i;y = 5+20*j;rect(x,y, 10,10);}}", b:"# LOC:3 for lerp rect\n"},
		for05: {a:"rectMode(CENTER);for (i of range(10)) {x = 10+20*i;y = 10;w = 2*i;h = 2*i;rect(x,y, w,h);}", b:"# LOC:3 for lerp rect rectMode\n"},
		for06: {a:"rectMode(CENTER);for (i of range(10)) {fc(i/10.0,0,0);x = 10+20*i;y = 10;w = 2*i;h = 2*i;rect(x,y,w,h);}", b:"# LOC:4 fc for lerp rect rectMode\n"},
		for07: {a:"for (i of range(10)) {fc(i/10.0,0,0);x = 10+20*i;y = 10;r = i;circle(x,y,r);}", b:"# LOC:3 for fc circle lerp\n"},
	...
	Assert1: {
		...
		Operator2: { a:"function f(x) { return x+1 }", b:"# + - * / %\n", c: { "f(7)":8, "f(8)":9, }}, 
		Operator3: { a:"function f(x) { return 2*x }", b:"# + - * / %\n", c: { "f(5)":10, "f(6)":12, }}, 
		Operator4: { a:"function f(x) { return x*x }", b:"# + - * / %\n", c: { "f(5)":25, "f(6)":36, }}, 
		Operator5: { a:"function f(x) { return -x }", b:"# + - * / %\n", c: { "f(-4)":4, "f(3)":-3, }}, 
		Operator6: { a:"function f(x) { return x-2 }", b:"# + - * / %\n" , c: { "f(7)":5, "f(17)":15, }}, 
		Operator7: { a:"function f(x) { return x/2 }", b:"# + - * / %\n", c: { "f(8)":4, "f(6)":3, }}, 
		Operator8: { a:"function f(x) { return x%2 }", b:"# + - * / %\n", c: { "f(7)":1, "f(8)":0, "f(10)":0, "f(11)":1,}}, 
	},
	Assert2: {
		Operator1: { a:"function g(a,b) { return a*b }", b:"# + - * / %\ng = (a,b) -> 0", c: { "g(3,4)":12, "g(4,6)":24, }}, 
		Operator2: { a:"function g(a,b) { return a+b }", b:"# + - * / %\n", c: { "g(3,4)":7, "g(4,6)":10, }}, 
		Operator3: { a:"function g(a,b) { return b-a }", b:"# + - * / %\n", c: { "g(3,4)":1, "g(4,6)":2, }}, 
		Operator4: { a:"function g(a,b) { return a/b }", b:"# + - * / %\n", c: { "g(8,4)":2, "g(12,3)":4, }}, 
		Operator5: { a:"function g(a,b) { return a%b }", b:"# + - * / %\n", c: { "g(8,4)":0, "g(9,4)":1, "g(10,4)":2, "g(11,4)":3, }}, 
	},
