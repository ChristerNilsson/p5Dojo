...
var Application, bg, bgc, block, buffer, call, calls, changeLayout, chapter, circle, co, compare, d, dd, decorate, editor_change, exercise, fc, fcc, fetch, fillSelect, fillTable, fixColor, fix_frames, gap, grid, ip, linkAppend, linksClear, mousePressed, msg, myCodeMirror, myprint, range, rd, reset, resizeTimer, run, run0, run1, saveToKeyStorage, sc, scc, sel1, sel1change, sel1click, sel2, sel2change, sel2click, sel3, sel3change, sel3click, setLinks, setMsg, setup, store, sw, tableAppend, tableClear, tcc,
...
Application = (function() {
  function Application(_name1, classes) {
    var _name, key, obj, ref, value;
